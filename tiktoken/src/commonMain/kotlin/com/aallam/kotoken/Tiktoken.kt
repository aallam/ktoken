...
import com.aallam.kotoken.internal.Tokeniser
 ...
 *
 * The companion object provides methods to obtain an instance of [Tiktoken] with specified encodings, either by encoding name or model name.
 */
public interface Tiktoken {
    ...
    public companion object {
        ...
        /**
         * Asynchronously obtains an instance of [Tiktoken] with the specified encoding scheme.
         *
         ...
         * @return An instance of [Tiktoken] with the specified encoding.
         */
         ...
         * @param loader The loader to be used for obtaining the encoding scheme.
         * @return An instance of [Tiktoken] with the encoding scheme for the specified model.
         */
        public suspend fun getEncodingForModel(model: String, loader: BpeLoader = RemoteBpeLoader()): Tiktoken {
            val encoding = Encoding.getEncodingForModel(model, loader)
            return build(encoding)
        }

        /**
         * Builds and returns an instance of [Tiktoken] based on the specified [Encoding].
         *
         * @param encoding The [Encoding] object representing the encoding scheme to be used.
         * @return An instance of [Tiktoken].
         */
        private fun build(encoding: Encoding): Tiktoken {
            ...
            return Tokeniser(bpe = coreBPE, specialTokensSet = specialTokensSet)
        }
    }
}
